            ...
            <div>
              <div className="relative">
                <motion.div
                  ...
                  className="aspect-square rounded-2xl overflow-hidden bg-transparent flex items-center justify-center p-0"
                >
                  <img
              ...
              <div className="mt-3 grid grid-cols-3 gap-3">
                {images.map((img, i) => (
                  ...
                  >
                    <img src={img} alt={`${product.name} view ${i + 1}`} loading="lazy" width={300} height={300} className="h-full w-full object-contain bg-transparent" />
                  </button>
                ))}
              </div>
            </div>
